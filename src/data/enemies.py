...
enemy_seek_kinematic = [
    {
        ...
        "position": (configs.RENDER_TILE_SIZE*16, configs.RENDER_TILE_SIZE*22),
...
enemy_arrive_kinematic = [
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*20, configs.RENDER_TILE_SIZE*22),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
...
enemy_seek_dynamic = [
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*24, configs.RENDER_TILE_SIZE*22),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
...
enemy_flee_dynamic = [
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*31, configs.RENDER_TILE_SIZE*31),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
...
enemy_arrive_dynamic = [
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*28, configs.RENDER_TILE_SIZE*22),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
...
enemy_velocity_match = [
    ...
    {
        "type": "gargant-soldier",
        "position": (configs.RENDER_TILE_SIZE*36, configs.RENDER_TILE_SIZE*26),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.VELOCITY_MATCH,
        "max_speed": 250.0,
        "target_radius": 40.0,
...
enemy_pursue = [
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*32, configs.RENDER_TILE_SIZE*22),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
...
enemy_face = [
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*28, configs.RENDER_TILE_SIZE*24),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*32, configs.RENDER_TILE_SIZE*24),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*36, configs.RENDER_TILE_SIZE*24),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*36, configs.RENDER_TILE_SIZE*28),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*36, configs.RENDER_TILE_SIZE*32),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*36, configs.RENDER_TILE_SIZE*36),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*32, configs.RENDER_TILE_SIZE*36),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*28, configs.RENDER_TILE_SIZE*36),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*24, configs.RENDER_TILE_SIZE*36),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*24, configs.RENDER_TILE_SIZE*32),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
    ...
    {
        "type": "gargant-berserker",
        "position": (configs.RENDER_TILE_SIZE*24, configs.RENDER_TILE_SIZE*28),
        "collider_box": (configs.ENEMY_COLLIDER_BOX_WIDTH, configs.ENEMY_COLLIDER_BOX_HEIGHT),
        "algorithm": configs.ALGORITHM.FACE,
        "max_speed": 180.0,
        "target_radius": 5 * configs.CONVERT_TO_RAD,
...
path_circle = {
    "type": "circle",
    "params": {"radius": 300.0, "segments": 48, "center": (configs.RENDER_TILE_SIZE * 30, configs.RENDER_TILE_SIZE * 30)},
    "offset": 2,
}
...
path_rect = {
    "type": "rectangle",
    "params": {"width": 700.0, "height": 700.0, "segments": 70, "center": (configs.RENDER_TILE_SIZE * 30, configs.RENDER_TILE_SIZE * 30)},
    "offset": 3,
}
